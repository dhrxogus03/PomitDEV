		...
		menu : {
			...
			template : {
				...
				tabItem : function(text, name){
					var label = text;
					var item = jQuery('<li class="menu text-only" name="'+name+'"><label style="white-space: pre;">'+ getXSSEncodedValue({"value":label, "encodeType":"html"}) +'</label><span class="close"></span></li>');

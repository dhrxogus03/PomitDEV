...
try
{
	...
	String iconPath = request.getHeader("IconPath");
	...
	must_shutdown_context = true;
        ...
        }else if(iconPath!=null && !"".equals(iconPath) && !"null".equals(iconPath)){
				  StartupCustoIconManager.deleteCustoIconFile(iconPath);
		}

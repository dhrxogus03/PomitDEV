...
<%
  ...
  contentURL.append("emxFullSearch.jsp?table=AEFGeneralSearchResults&selection=multiple&hideHeader=true&field=TYPES!=type_SecurityContext&showClipboard=false&showInitialResults=false&addPreCondParam=true");

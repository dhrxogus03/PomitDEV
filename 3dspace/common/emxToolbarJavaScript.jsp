...
String formFieldsOnly = emxGetParameter(requestMap, "formFieldsOnly");
...
if ("true".equalsIgnoreCase(editLink)) 
{
    ...
    if ("form".equals(uiType)){
        ...
        if(UIUtil.isNotNullAndNotEmpty(formFieldsOnly)) {
        	strEditURL.append("&formFieldsOnly=");
        	strEditURL.append(XSSUtil.encodeForURL(context, formFieldsOnly));
        }

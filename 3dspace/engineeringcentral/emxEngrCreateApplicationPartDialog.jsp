...
<%
  ...
  String RDO              = "";
  String RDOId            = "";
  String locName          = person.getPerson(context).getCompany(context).getInfo(context,DomainConstants.SELECT_ATTRIBUTE_TITLE);
  String locId            = person.getPerson(context).getCompany(context).getInfo(context,DomainConstants.SELECT_ID);
  String defaultLocation  = person.getPerson(context).getCompany(context).getInfo(context,DomainConstants.SELECT_ATTRIBUTE_TITLE);

...
String levelStr       = EnoviaResourceBundle.getProperty(context, "emxEngineeringCentralStringResource", context.getLocale(),"emxEngineeringCentral.Common.Levels");
  ...
  if (displayPage.equalsIgnoreCase("AVL")) {
     locationName = Person.getPerson(context).getCompany(context).getInfo(context,DomainConstants.SELECT_ATTRIBUTE_TITLE);
...
%>
       ...
       subHead += "|";
		...
		if( subHead && subHead.indexOf("|") > -1) {
			subHead =subHead.replace(/\|/g, encodeURIComponent("|"));
		}

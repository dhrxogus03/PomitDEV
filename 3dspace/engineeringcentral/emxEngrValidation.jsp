...
function preProcessInEditPart() {
	...
	//Disable work under change field value only if field is non-empty and change belongs to group
	if($('input[name=WorkUnderfieldValue]').val() !='' && $('input[name=changeBelongsToGroup]').val() == undefined){	
	...
	}else if($('input[name=WorkUnderfieldValue]').val() !='' && $('input[name=changeBelongsToGroup]').val() == "true"){
		$('input[name=WorkUnder]').val('');
		$('input[name=WorkUnderDisplay]').val('');
		$('input[name=WorkUnderfieldValue]').val('');
	}
	var disableYesOption = document.editDataForm.sDisableSparePartYesOption;
...
{
	if(document.editDataForm.SparePart!= undefined)
	{
		var sparePartSelect = document.editDataForm.elements["SparePart"];	

...
String objId = emxGetParameter(request, "objectId");
	...
	String resetNotPossibleError = EnoviaResourceBundle.getProperty(context, "emxBOMPartManagementStringResource", context.getLocale(),"emxBOMPartManagement.Validation.ResetFindNumberNotPossible");
	if(BOMMgtUtil.doEBOMServerValidation(context, objId)){
    	%>
    	<script>
	  alert("<%=resetNotPossibleError%>");
	  </script>
	<% 
	return;
	}

...
while (i.hasNext())
{
   ...
   if(mepId!=null && !mepId.equals("") && !mepId.equals("null")) {
	   ...
	   if((DomainConstants.TYPE_COMPANY).equalsIgnoreCase((String)resultsMap.get(DomainObject.SELECT_TYPE))){
			map.put(LOCATIONNAME, (String) resultsMap.get(DomainConstants.SELECT_ATTRIBUTE_TITLE));
	   }
 ...
 <!-- <table width="100%" border="0" cellpadding="3" cellspacing="2"> -->  <!--Modified for IR-118698V6R2012x -->
  <table class="list">   
    <tr>
      ...
      <th nowrap="nowrap">
             <emxUtil:i18n localize="i18nId">emxEngineeringCentral.Common.LocationTitle</emxUtil:i18n>
      </th>
      <th nowrap="nowrap">

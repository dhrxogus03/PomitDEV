...
<%
   ...
   while(mapItr.hasNext())
	  ...
	  objectSelects.add("relationship[Manufacturing Responsibility].from."+DomainConstants.SELECT_ATTRIBUTE_TITLE);
...
<td class="listCell" style="text-align: " valign="top"><a href="javascript:emxShowModalDialog('<xss:encodeForURL><%=newWinURL%></xss:encodeForURL>',700,600,false)"> <xss:encodeForHTML><%=(String)tempMap.get("relationship[Manufacturing Responsibility].from."+DomainConstants.SELECT_ATTRIBUTE_TITLE)%></xss:encodeForHTML></a></td>
<td class="listCell" style="text-align: " valign="top">
<table>

           ...
           //XSSOK
            ...
            if ("0" == selectedRowId &&  mode!='AVLCopyFrom') {
            	...
            	if(mode == 'changePosition'){
            		...
            		contentFrame.showModalDialog("<xss:encodeForJavaScript><%=contentURL%></xss:encodeForJavaScript>", 575, 575);
            	}           	
            }

...
<%
	...
	if("updatePart".equals(functionality))
	{
			...
			//Change objects in state Implemented, Released and Cancelled should be considered as inactive change
			String sWhereClause = "Current != "+EngineeringConstants.STATE_ECO_RELEASE +" && Current != "+EngineeringConstants.STATE_ECO_IMPLEMENTED +" && Current != "+EngineeringConstants.STATE_ECO_CANCELLED;
			...
			if(isStateLTFrozen){
				MapList changeConnected = domObj.getRelatedObjects(context,
 						...
 						null, true, false, (short) 1, sWhereClause, null, 0);

...
<%
    ...
    for(int i=0,arrayLen = mapList.size();i < arrayLen;i++)
    {
        ...
        String strObjName = (String)map.get(DomainConstants.SELECT_ATTRIBUTE_TITLE);
        strObjName = strObjName!=null && !strObjName.isEmpty()? strObjName : (String)map.get(DomainConstants.SELECT_NAME);
        String strObjId = (String)map.get(DomainConstants.SELECT_ID);

 ...
 <%
  ...
  boolean boolHostCompanyEmployee=false;
     ...
     //  if ((routeName.equals("")) && (routeAutoName.equals("")))
       ...
       routeDescription= FrameworkUtil.findAndReplace(routeDescription, "E:N:T:E:R", "\n");
...
function doCheck(){
 ...
 var chkList  = objForm.chkList;
  ...
  function AddContent() {
   var routeName1 = document.createDialog.routeName.value;
   var description1 = encodeURIComponent(document.createDialog.txtdescription.value);
   //var routeStart1 = document.createDialog.routeStart.value;
   var routeStart1 = null;
...
description1 = description1.replace(/%0A/g, "E:N:T:E:R");
...
emxShowModalDialog(url,750,500);
 ...
 %>
	  var strURL="../common/emxFullSearch.jsp?field=TYPES=type_RouteTemplate:CURRENT=policy_RouteTemplate.state_Active:ROUTE_COMPLETION_ACTION=Notify Route Owner:LATESTREVISION=TRUE:LINK_TEMPLATE=FALSE:CHOICE_TEMPLATE!=TRUE&table=RouteTemplateSummary&selection=single&fieldNameActual=Template&fieldNameDisplay=TemplateDisplay&mode=Chooser&chooserType=CustomChooser&HelpMarker=emxhelpfullsearch&showInitialResults=false&submitURL=../components/emxComponentsFullSearchUtil.jsp&fromPage=routeWizard&displayView=details";

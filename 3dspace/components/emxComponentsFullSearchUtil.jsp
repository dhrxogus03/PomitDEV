...
<%
	...
	if(fromPage.equals("routeTemplate")){
    	...
    	String selObjState = selObject.getInfo(context, DomainConstants.SELECT_CURRENT);
    	%>
    	<script language="javascript">
         var form = getTopWindow().getWindowOpener().document.forms[0];
         if (form) {
        	 if(<%="Inactive".equalsIgnoreCase(selObjState) || "Archive".equalsIgnoreCase(selObjState)%>){
        		 alert("<emxUtil:i18n localize = "i18nId">emxFramework.Common.PleaseSelectActiveTemplate</emxUtil:i18n>");
             }else {
    	...
    	DomainObject selObject = new DomainObject(selObjId);
    	String selObjName = selObject.getInfo(context, DomainConstants.SELECT_NAME);
    	String selCurrentState = selObject.getInfo(context, DomainConstants.SELECT_CURRENT);
        ...
        if(<%="Inactive".equalsIgnoreCase(selCurrentState) || "Archive".equalsIgnoreCase(selCurrentState)%>){
        	alert("<emxUtil:i18n localize = "i18nId">emxFramework.Common.PleaseSelectActiveTemplate</emxUtil:i18n>");
        }else {
       ...
       }else if(fromPage.equals("routeWizard"))
    {
    	...
    	String templateState = (String)resultMap.get(DomainConstants.SELECT_CURRENT);
    ...
    <script language="javascript">
        ...
        if (form) {
            ...
            if(<%="Inactive".equalsIgnoreCase(templateState) || "Archive".equalsIgnoreCase(templateState)%>){
            	alert("<emxUtil:i18n localize = "i18nId">emxFramework.Common.PleaseSelectActiveTemplate</emxUtil:i18n>");
            }else {
            	if (form.template) {
            ...
            // if the chooser is in the Form
		            else if (strSearchMode.equals("CustomChooser"))
		            {
		            	...
		            	if(!strObjectId.equals(null) || !"".equals(strObjectId))
		          	{
		          		...
		          		templateState = (String) resultMap.get(routeTemplateObj.SELECT_CURRENT);

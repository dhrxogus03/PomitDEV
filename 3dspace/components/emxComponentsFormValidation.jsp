...
//
       ...
       function showECReviewerList()
       {
           var objCommonAutonomySearch = new emxCommonAutonomySearch();
            ...
            objCommonAutonomySearch.field = "TYPES=type_RouteTemplate:CURRENT=policy_Organization.state_Active:ROUTE_COMPLETION_ACTION=Notify Route Owner:ROUTE_BASE_PURPOSE=Review:LINK_TEMPLATE=FALSE:CHOICE_TEMPLATE!=TRUE";
       ...
       function showECApprovalList()
       {
           var objCommonAutonomySearch = new emxCommonAutonomySearch();
            ...
            objCommonAutonomySearch.field = "TYPES=type_RouteTemplate:CURRENT=policy_Organization.state_Active:ROUTE_COMPLETION_ACTION=Notify Route Owner:ROUTE_BASE_PURPOSE=Approval:LINK_TEMPLATE=FALSE:CHOICE_TEMPLATE!=TRUE";
            objCommonAutonomySearch.selection = "single";
  ...
  function routeTemplateEditScopeClearAll()
{
  ...
  function validateCompanyTitle(fieldName){
	   if(!fieldName) {
			 fieldName=this;
  		}
	   return validateOrgName(getOrgCurrentValueFromFieldName(fieldName), trim(fieldName.value))

        ...
        objectGeneral.setId(objectId);
         ...
         sProjectId = (String)map1.get("workspaceId");
           ...
           if(routeName == null || "null".equals(routeName) || "".equals(routeName)){
                ...
                routeName = FrameworkUtil.autoName(context,routeTemplateTypeAdminAlias,  "1",	routeTemplatePolicyAdminAlias,
 						null,
 						null,
 						true,
 						true);
                ...
                attrMap.put(sAttrRouteCompletion, routeCompletionAction);

...
//modified for 316923 Adhoc issue start
  ...
  boolean bDeltaDueDate       = false;
    ...
    String selectUsersFromUGChkItem1                  = "False";
    ...
    if (routeNode != null) {
      ...
      for (int i = 0; i < routeNode.length; i++) {
        ...
        selectUsersFromUGChkItem1= emxGetParameter(request, "chooseUsersRouteFromUG"+i);
        ...
        //End for Bug 330196 OCT 12 2007
		if((selectUsersFromUGChkItem == null || "null".equals(selectUsersFromUGChkItem)) && (selectUsersFromUGChkItem1== null || "null".equals(selectUsersFromUGChkItem1))){

var stuContextRequires = ['DS/StuCore/StuContext', 'DS/StuModel/StuBehavior', 'DS/EPEventServices/EPEvent', 'DS/EPEventServices/EPEventServices', 'DS/MathematicsES/MathsDef', 'DS/StuRenderEngine/StuCameraNa', 'DS/StuRenderEngine/StuActor3D'];
...
define('DS/StuSound/StuSoundPlayer', stuContextRequires, function (STU, Behavior, Event, EventServices, DSMath, Camera, Actor3D) {
	'use strict';

	//////////////////////////////////////////////////////////////////////////
	// Events thrown for NL
	//////////////////////////////////////////////////////////////////////////
	...
	/**
	 * This event is thrown when the sound player tries to re-play the sound
	 *
	...
	/**
	 * This event is thrown when the sound player hasfinished to play the sound
	 *
	...
	SoundPlayer.prototype.handleSoundFinished = function () {
		...
		if (this._hasStartedPlaying === true) {
			...
			if (this.playPosition === 0) {
				...
				var evt = new SoundPlayerFinishedEvent();
	...
	SoundPlayer.prototype.play = function () {
		...
		if (this.playPosition === 0) {
			evt = new SoundPlayerStartedEvent();
		}
		else {
			evt = new SoundPlayerResumedEvent();
		}
		actor.dispatchEvent(evt);
	};
	...
	SoundPlayer.prototype.pause = function () {
		...
		var actor = this.getActor();
		var evt = new SoundPlayerPausedEvent();
		actor.dispatchEvent(evt);
	};
	...
	SoundPlayer.prototype.stop = function () {
		...
		var actor = this.getActor();
		var evt = new SoundPlayerStoppedEvent();
		actor.dispatchEvent(evt);

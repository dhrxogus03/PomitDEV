							...
							Ok: new WUXButton({
								...
								onClick: function (e) {
									if (usingDelegatedAuthentication) {
										...
										}else if((userName.value.toLowerCase() != taskAssigneeUserName.toLowerCase()) && (userName.value.toLowerCase() != ESignDetailsBootstrap.getLoginUserEmail().toLowerCase())){

	...
	function(
		...
		var PartContentsCollection = PageableCollection.extend({
			...
			fetch: function(options) {
              ...
              this.options.data.tenant=(widget&&(widget.getValue('x3dPlatformId') != '' && widget.getValue('x3dPlatformId') != undefined)&&(UWA.is(widget.getValue('x3dPlatformId'))) )? widget.getValue('x3dPlatformId'):"OnPremise";

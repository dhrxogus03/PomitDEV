...
], function(Element, Modal, WUXButton, WUXComboBox, PADContext, WUXSpinBox, NotificationsManagerUXMessages, NotificationsManagerViewOnScreen, PlatformAPI, WAFData, NLS){
        ...
        execute: function () {
        	...
        	var newModal = new Modal({
                ...
                footer: [new WUXButton({
        	        		label: NLS.labelOK,
        	        		emphasize: 'primary',
        	    			allowUnsafeHTMLLabel: true, // XSS_CHECKED
        	        		onClick: function () {

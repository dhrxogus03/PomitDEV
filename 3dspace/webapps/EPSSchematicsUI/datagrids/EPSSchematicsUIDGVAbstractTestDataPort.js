...
define("DS/EPSSchematicsUI/datagrids/EPSSchematicsUIDGVAbstractTestDataPort", ["require", "exports", "DS/EPSSchematicsUI/datagrids/EPSSchematicsUIDGVAbstractDataItem", "DS/EPSSchematicsUI/datagrids/EPSSchematicsUIDGVDataItemTools", "DS/EPSSchematicsUI/datagrids/EPSSchematicsUIDGVTools", "i18n!DS/EPSSchematicsUI/assets/nls/EPSSchematicsUINLS"], function (require, exports, UIDGVAbstractDataItem, UIDGVDataItemTools, UIDGVTools, UINLS) {
    ...
    class UIDGVAbstractTestDataPort extends UIDGVAbstractDataItem {
            ...
            this._columns.push({
                ...
                getCellEditableState: cellInfos => {
                    ...
                    if (nodeModel) {
                        ...
                        result = !UIDGVTools.isAnyObjectType(this._graphContext, valueType);
                    }
                    return result;
                },
        ...
        _getActionsColumnWidth() {
            return 4 * UIDGVAbstractDataItem._iconWidth;
        }
        /**
        ...
        _createDataPortNodeModel(dataPort) {
            let nodeModel = this._createDataItemNodeModel(dataPort, 'testValue', false, true);

    ...
    class UIDGVAbstractDataItem extends UIDGVAbstractModelItem {
        ...
        _defineDefaultValueColumn() {
            this._columns.push({
                ...
                getCellEditableState: cellInfos => UIDGVDataItemTools.getDataItemDefaultValueCellEditableState(cellInfos, this._dataIndex, this._readOnly),
        ...
        _defineActionsColumn() {
            const width = this._getActionsColumnWidth();
            this._columns.push({
                dataIndex: 'actions',
        ...
        /**
         * Gets the actions column width.
         * @protected
         * @static
         * @returns {number} The actions column width.
         */
        // eslint-disable-next-line class-methods-use-this
        _getActionsColumnWidth() {
            return (globalThis.EPSDGVPROTO === true ? 4 : 2) * UIDGVAbstractDataItem._iconWidth;
        }
        /**
         ...
         * @param {boolean} [showHierarchy=false] - Whether to show the hierarchy.
         * @returns {WUXTreeNodeModel} The created node model.
         */
        _createDataItemNodeModel(dataItem, valueDataIndex, hasSectionActions, showHierarchy = false) {
            let nodeModel;
            if (dataItem !== undefined) {
                ...
                const displayExpanders = globalThis.EPSDGVPROTO === true || showHierarchy === true;
                const options = {
                    ...
                    ...(displayExpanders && { children: canExpand ? [] : undefined })
                };
        ...
        _renameCSIDefaultValueDGVColumn(editor, dataPort) {
            ...
            result = result && dataPort.getType() === ModelEnums.EDataPortType.eInput;
         ...
         * @protected
         * @param {EDataPortType} dataPortType - The data port type.

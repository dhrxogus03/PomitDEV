...
define("DS/EPSSchematicsUI/datagrids/EPSSchematicsUIDGVTools", ["require", "exports", "DS/EPSSchematicsModelWeb/EPSSchematicsModelEnums", "DS/EPSSchematicsModelWeb/EPSSchematicsTools", "DS/EPSSchematicsModelWeb/EPSSchematicsTypeLibrary", "i18n!DS/EPSSchematicsUI/assets/nls/EPSSchematicsUINLS"], function (require, exports, ModelEnums, Tools, TypeLibrary, UINLS) {
    "use strict";
    ...
    class UIDGVTools {
        ...
        static isReadOnlyRoot(editor, dataPort) {
            const isRootInput = dataPort?.block.toPath() === Tools.rootPath && dataPort.getType() === ModelEnums.EDataPortType.eInput;
         ...
         */
        static isEmptyLocalCustomType(dataItem) {
            const valueType = dataItem.getValueType();
            const localCustomType = TypeLibrary.getLocalCustomType(dataItem.block.getGraphContext(), valueType);
        ...
        static getDefaultValueFromValueType(valueType, graphContext) {
            ...
            else if (valueType === 'Array' || (typeCategory & ModelEnums.FTypeCategory.fArray) === ModelEnums.FTypeCategory.fArray) {
                result = [];
            }
            else if ((typeCategory & ModelEnums.FTypeCategory.fNumerical) === ModelEnums.FTypeCategory.fNumerical) {
            ...
            else if ((typeCategory & ModelEnums.FTypeCategory.fObject) === ModelEnums.FTypeCategory.fObject ||
                (typeCategory & ModelEnums.FTypeCategory.fClass) === ModelEnums.FTypeCategory.fClass ||
                (typeCategory & ModelEnums.FTypeCategory.fEvent) === ModelEnums.FTypeCategory.fEvent) {

    ...
    class UIBlockLibraryPanel extends UISplittedPanel {
        ...
        _searchByDataPort(valueToSearch) {
            ...
            if (this._buttonGroupPort.value.length === 1) {
                ...
                const portType = isInputPort ? ModelEnums.EDataPortType.eInput : ModelEnums.EDataPortType.eOutput;
                dataPorts = dataPorts.filter(dp => dp.getType() === portType);
            }
        ...
        _updateButtonGroupProperties(properties) {
            ...
            properties.forEach((property, index) => {
                const button = new WUXButton({
                    ...
                    value: property,
                    checkFlag: index === 0 || property === UIEnums.EBlockLibraryPropertySearchFilter.eCategory,
         ...
         * @private
         * @static
         * @param {WUXEvent} event - The WUX event.
         */

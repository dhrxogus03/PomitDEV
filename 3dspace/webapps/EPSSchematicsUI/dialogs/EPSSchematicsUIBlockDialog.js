...
define("DS/EPSSchematicsUI/dialogs/EPSSchematicsUIBlockDialog", ["require", "exports", "DS/EPSSchematicsUI/dialogs/EPSSchematicsUITemporaryModelDialog", "DS/EPSSchematicsUI/tools/EPSSchematicsUIDom", "DS/EPSSchematicsUI/tools/EPSSchematicsUIFontIcon", "DS/EPSSchematicsUI/tools/EPSSchematicsUITools", "DS/EPSSchematicsUI/tools/EPSSchematicsUIWUXTools", "i18n!DS/EPSSchematicsUI/assets/nls/EPSSchematicsUINLS", "DS/EPSSchematicsUI/typings/WebUX/controls/EPSWUXTab", "DS/Controls/LineEditor", "DS/Controls/Button", "DS/EPSSchematicsUI/typings/WebUX/controls/EPSWUXComboBox", "DS/EPSSchematicsModelWeb/EPSSchematicsEvents", "DS/EPSSchematicsUI/datagrids/EPSSchematicsUIDGVControlPorts", "DS/EPSSchematicsUI/datagrids/EPSSchematicsUIDGVDataPorts", "DS/EPSSchematicsUI/datagrids/EPSSchematicsUIDGVSettings", "DS/EPSSchematicsModelWeb/EPSSchematicsModelEnums", "css!DS/EPSSchematicsUI/css/dialogs/EPSSchematicsUIBlockDialog"], function (require, exports, UITemporaryModelDialog, UIDom, UIFontIcon, UITools, UIWUXTools, UINLS, WUXTab, WUXLineEditor, WUXButton, WUXComboBox, Events, UIDGVControlPorts, UIDGVDataPorts, UIDGVSettings, ModelEnums) {
    "use strict";
    ...
    class UIBlockDialog extends UITemporaryModelDialog {
        ...
        constructor(block, options) {
            super(block.getEditor(), block.getModel(), UITools.mergeObject({
         ...
         * @public
         * @returns {WUXButton} The nodeId selector undefined button.
         */
        ...
        _onOk() {
            if (UITools.isBlockDataPortDebuggable(this._editor, this._block.getModel())) {
                ...
                const breakBlockData = UITools.getBreakBlockData(this._editor, this._tmpModel.getDataPorts(ModelEnums.EDataPortType.eInput), fromDebugByDataPortPath);
        ...
        _createNodeIdSelectorComboBox() {
            if (this._tmpModel.isNodeIdSelectorSettable()) {
                ...
                this._nodeIdSelectorUndefinedButton = new WUXButton({
                    ...
                    disabled: nodeIdSelector === undefined,
                    onClick: () => {
        ...
        _createTab() {
            ...
            this._dgvControlPorts = new UIDGVControlPorts(this._editor, this._tmpModel, false);
            ...
            this._dgvDataPorts = new UIDGVDataPorts(this._editor, this._tmpModel, false);
            ...
            this._dgvSettings = new UIDGVSettings(this._editor, this._tmpModel, false);

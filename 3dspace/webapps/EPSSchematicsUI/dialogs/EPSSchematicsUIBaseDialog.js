...
define("DS/EPSSchematicsUI/dialogs/EPSSchematicsUIBaseDialog", ["require", "exports", "DS/EPSSchematicsUI/tools/EPSSchematicsUIDom", "DS/Windows/Dialog", "DS/Controls/Button", "css!DS/EPSSchematicsUI/css/dialogs/EPSSchematicsUIBaseDialog"], function (require, exports, UIDom, Dialog, WUXButton) {
    ...
    class UIBaseDialog {
        ...
        _createDialog() {
            ...
            const className = Array.isArray(this._options.className) ? this._options.className : [this._options.className];
        ...
        _generateButtons() {
            if (this._options.buttonsDefinition !== undefined) {
                const buttonsName = Object.keys(this._options.buttonsDefinition);
                buttonsName.forEach(buttonName => {
                    this._options.buttons[buttonName] = new WUXButton(this._options.buttonsDefinition[buttonName]);
                });
            }
        }
    }

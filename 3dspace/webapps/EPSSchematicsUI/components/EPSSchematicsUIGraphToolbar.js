    ...
    class UIGraphToolbar {
        ...
        _createExpanderToolbar() {
            ...
            if (options.hideGraphToolbarButton !== 511 /* UIEnums.FGraphToolbarButton.fAllButton */) {
                ...
                if (!(options.hideGraphToolbarButton & 1 /* UIEnums.FGraphToolbarButton.fLoad */)) {
                    const isExpanded = options.expandGraphToolbarButton & 1 /* UIEnums.FGraphToolbarButton.fLoad */;
                ...
                if (!(options.hideGraphToolbarButton & 2 /* UIEnums.FGraphToolbarButton.fSave */)) {
                    const isExpanded = options.expandGraphToolbarButton & 2 /* UIEnums.FGraphToolbarButton.fSave */;
                ...
                if (!(options.hideGraphToolbarButton & 4 /* UIEnums.FGraphToolbarButton.fClear */)) {
                    const isExpanded = options.expandGraphToolbarButton & 4 /* UIEnums.FGraphToolbarButton.fClear */;
                    const rootViewer = this._editor.getViewerController().getRootViewer();
                ...
                if (!(options.hideGraphToolbarButton & 8 /* UIEnums.FGraphToolbarButton.fGraphAnalyzer */)) {
                    const isExpanded = options.expandGraphToolbarButton & 8 /* UIEnums.FGraphToolbarButton.fGraphAnalyzer */;
                ...
                if (!(options.hideGraphToolbarButton & 16 /* UIEnums.FGraphToolbarButton.fDataLinkMinimizer */)) {
                    const isExpanded = options.expandGraphToolbarButton & 16 /* UIEnums.FGraphToolbarButton.fDataLinkMinimizer */;
                ...
                if (!(options.hideGraphToolbarButton & 32 /* UIEnums.FGraphToolbarButton.fContrast */)) {
                    const isExpanded = options.expandGraphToolbarButton & 32 /* UIEnums.FGraphToolbarButton.fContrast */;
                ...
                if (!(options.hideGraphToolbarButton & 64 /* UIEnums.FGraphToolbarButton.fNodeIdSelectors */)) {
                    const isExpanded = options.expandGraphToolbarButton & 64 /* UIEnums.FGraphToolbarButton.fNodeIdSelectors */;
                ...
                if (!(options.hideGraphToolbarButton & 128 /* UIEnums.FGraphToolbarButton.fCreateComment */)) {
                    const isExpanded = options.expandGraphToolbarButton & 128 /* UIEnums.FGraphToolbarButton.fCreateComment */;
                ...
                if (!(options.hideGraphToolbarButton & 256 /* UIEnums.FGraphToolbarButton.fEditorSettings */)) {
                    const isExpanded = options.expandGraphToolbarButton & 256 /* UIEnums.FGraphToolbarButton.fEditorSettings */;

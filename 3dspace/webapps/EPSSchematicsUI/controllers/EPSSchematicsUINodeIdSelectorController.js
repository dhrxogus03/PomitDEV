...
define("DS/EPSSchematicsUI/controllers/EPSSchematicsUINodeIdSelectorController", ["require", "exports", "DS/EPSSchematicsUI/typings/WebUX/EPSWUXTreeDocument", "DS/EPSSchematicsModelWeb/EPSSchematicsTools", "DS/EPSSchematicsModelWeb/EPSSchematicsEvents", "i18n!DS/EPSSchematicsUI/assets/nls/EPSSchematicsUINLS", "DS/EPSSchematicsUI/EPSSchematicsUIEnums", "DS/Utilities/Color", "DS/EPSSchematicsModelWeb/EPSSchematicsNodeIdSelector", "DS/EPSSchematicsUI/typings/WebUX/EPSWUXTreeNodeModel", "DS/EPSSchematicsModelWeb/EPSSchematicsModelEnums"], function (require, exports, WUXTreeDocument, Tools, Events, UINLS, UIEnums, WUXColor, NodeIdSelector, WUXTreeNodeModel, ModelEnums) {
    "use strict";
    /**
    ...
    class UINodeIdSelectorController {
        ...
        fromJSON(iJSONGraph) {
            if (iJSONGraph.nodeIdSelectors !== undefined) {
                ...
                nodeIdSelectors.forEach((nodeIdSelector, index) => {
                    const color = iJSONGraph.nodeIdSelectors[index];
                    if (color !== undefined) {
        ...
        _initializeTreeDocument() {
            const _noNodeIdSelectorNodeModel = new WUXTreeNodeModel({
                label: 'No NodeId Selector',
                grid: { color: undefined, applyNodeIdSelector: this._applyNodeIdSelectorIconCB }
            });
            const _parentNodeIdSelectorNodeModel = new WUXTreeNodeModel({
        ...
        _onNodeIdSelectorCriterionChange(event) {
            ...
            if (nodeModel) {
                let criterion = event.getCriterion();
                criterion = criterion === undefined ? -1 : criterion;

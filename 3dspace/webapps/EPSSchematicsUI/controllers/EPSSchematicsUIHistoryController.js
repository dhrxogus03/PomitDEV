            ...
            if (currentJSONGraph !== previousJSONGraph || action === UIHistoryAction.eChangeViewer) {
                ...
                const nodeModel = new WUXTreeNodeModel({
                    grid: {
                        ...
                        currentIcon: { iconName: 'arrow-right', fontIconFamily: WUXManagedFontIcons.FontAwesome },
                        isCurrent: false,
                        isDisabled: false,

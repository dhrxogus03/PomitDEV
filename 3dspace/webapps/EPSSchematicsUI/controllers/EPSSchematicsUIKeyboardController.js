        ...
        _onKeydown(event) {
            if (this._viewer.getEditionMode() === true) {
                ...
                if (this._isCtrlPressed) {
                    ...
                    event.preventDefault();
                    const viewer = this._editor.getViewerController().getCurrentViewer();
                    const smController = viewer.getStateMachineController();
                    const mousePos = smController.getMouseClientPosition();
                    const mouseLeft = mousePos.clientX;
                    const mouseTop = mousePos.clientY;

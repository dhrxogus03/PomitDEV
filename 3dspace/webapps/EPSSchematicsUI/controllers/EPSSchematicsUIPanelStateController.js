...
define("DS/EPSSchematicsUI/controllers/EPSSchematicsUIPanelStateController", ["require", "exports", "DS/EPSSchematicsUI/EPSSchematicsUIEnums", "DS/Core/WebUXGlobalEnums"], function (require, exports, UIEnums, WebUXGlobalEnums_1) {
    "use strict";
    /**
    ...
    class UIPanelStateController {
        ...
        initialize() {
            ...
            if (playPanelStateMap !== undefined) {
                playPanelStateMap.get(UIEnums.EViewMode.eEdit).visibleFlag = false;
                playPanelStateMap.get(UIEnums.EViewMode.ePlay).debugCommandsVisibleFlag = false;
                playPanelStateMap.get(UIEnums.EViewMode.eDebug).debugCommandsVisibleFlag = true;
            }
            ...
            if (watchPanelStateMap !== undefined) {
                watchPanelStateMap.get(UIEnums.EViewMode.eEdit).visibleFlag = false;
            }
        ...
        _initializePanelState(panelUI) {
            if (panelUI !== undefined) {
                ...
                Object.keys(UIEnums.EViewMode).forEach(viewMode => {
                    panelStateByViewModeMap.set(UIEnums.EViewMode[viewMode], {

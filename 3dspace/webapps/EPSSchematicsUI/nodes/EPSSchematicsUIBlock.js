    ...
    class UIBlock extends UINode {
        ...
        computeWidth() {
            ...
            if (blockView.getElement() !== undefined) {
                ...
                const dataInCount = this.getUIDataPorts(ModelEnums.EDataPortType.eInput, true).length;
        ...
        automaticExpandDataPorts() {
            ...
            const inputDataPorts = this.getUIDataPorts(ModelEnums.EDataPortType.eInput, false);
         ...
         * @param {ModelEnums.EDataPortType} portType - The data port type.
         */
        _dispatchDataPortsByType(portType) {
            const dataPorts = this.getUIDataPorts(portType, true);

/* global define */
define('DS/StuMiscContent/StuHelicopterController', [
	...
	function (STU, EP, Behavior, EventServices, Event, DSMath, Actor3D, PointActor, Location) {
		'use strict';
		...
		HelicopterController.prototype.fliesTo = function (actor) {
			if (actor !== this._target) {
				...
				if (this._target instanceof Actor3D) {
				...
				if (this._target instanceof PointActor) {
					this._isTargetOriented = false;
				}
				this._landingHeight = 0.0;
				this._totalActionTime = 0.0;
		...
		HelicopterController.prototype.isCloseToLand = function (iVector) {
			...
			if (iRef !== null && iRef !== undefined && iRef instanceof Location) {

define('DS/StuMiscContent/StuCapacityLauncher', [
...
], function (STU, Behavior, Task, EP, DSMath, StuVisuServices, Actor3D, Service, Function) {
	'use strict';
 ...
 */
    ...
    */
	...
	CapacityLauncher.prototype.setButtonCallback = function (myButton, myCapacity, myTask) {
		var callback;
		if (myCapacity instanceof Service) {
			callback = function (e) {
		...
		else if (myCapacity instanceof Function) {
			callback = function (e) {
				myCapacity.execute();
			}
		}

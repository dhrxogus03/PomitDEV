/* global define */
define('DS/StuMiscContent/StuTrafficManager', [
	...
	function (STU, EP, Behavior, DSMath, Collection, PathActor) {
	'use strict';
	...
	var TrafficManager = function () {
		...
		Object.defineProperty(this, 'roads', {
			...
			set: function (value) {
				var goodArgsType = (value instanceof Collection) || (value instanceof PathActor);
				if (goodArgsType) {
		...
		Object.defineProperty(this, 'cars', {
			...
			set: function (value) {
				var goodArgsType = (value instanceof Collection);
				if (goodArgsType) {
	...
	TrafficManager.prototype.checkParameters = function (iDumpError) {
        ...
        */
		if (this._roadsCollection === undefined || this._roadsCollection === null) {
			...
			var goodArgsType = (this._roadsCollection instanceof Collection) || (this._roadsCollection instanceof PathActor);

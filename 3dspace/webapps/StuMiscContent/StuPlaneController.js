...
define('DS/StuMiscContent/StuPlaneController', [
	...
	function (STU, EP, Behavior, EventServices, Event, DSMath, Actor3D, ProductActor, SubProductActor, PathActor) {
		'use strict';
		...
		PlaneController.prototype.findLowestPoint = function () {
			...
			if (this.actor instanceof ProductActor) {
				for (var s_actor in subActors) {
					var isSubProduct = subActors[s_actor] instanceof SubProductActor;
		...
		PlaneController.prototype.fliesTo = function (iTarget) {
			var goodArgsType = (iTarget instanceof Actor3D);
		...
		PlaneController.prototype.fliesAlong = function (iPath) {
			var goodArgsType = (iPath instanceof PathActor);

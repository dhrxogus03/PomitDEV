...
define('DS/StuHuman/StuHumanMotion',
    ...
    *
    * @deprecated use STU.Human#setTransform
    * @method
    * @public
    ...
    */
    HumanMotion.prototype.setLocation = function (iTransform, iRef) {
        ...
        if (actor instanceof STU.Human === true) {
            actor.setTransform(iTransform, iRef);
        }
    ...
    * By default, the function uses the World referential.
    *
    * @deprecated use STU.Human#getTransform
    * @method
    * @public
    * @param {STU.Actor3D} [iRef] instance object corresponding to the referential
    ...
    */
    HumanMotion.prototype.getLocation = function (iRef) {
        var actor = this.getActor();
        if (actor instanceof STU.Human === false) {
            return new DSMath.Transformation();
        }
        
        return actor.getTransform(iRef);
    };

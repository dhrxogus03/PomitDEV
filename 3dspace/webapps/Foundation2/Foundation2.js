...
define('DS/Foundation2/Models/ReferenceModel', ['UWA/Core', 'UWA/Utils', 'DS/Foundation2/FoundationV2Data',
        ...
        'DS/RDFFoundation/FederatedSearchUtil', 'DS/RDFFoundation/RDFUtils'
    ],
    function (UWA, Utils, FoundationData, FoundationBaseModel, UIHelper, Search, PlatformManager, FedSearchUtil, RDFUtils) {
        'use strict';
        ...
        var ReferenceModel = FoundationBaseModel.extend({
            ...
            canBeRemoved: function (iFieldName) {
              return true;
            }
        });

...
//      ...
//      else if (MyActor instanceof Actor3D)
//          ...
...
define('DS/StuPhysic/StuPhysicRigidBody', [
	'DS/StuCore/StuContext',
	'DS/MathematicsES/MathsDef',
	'DS/StuPhysic/StuCDSDynFactory',
	'DS/StuGeometricPrimitives/StuCubeActor',
	'DS/StuGeometricPrimitives/StuPlaneActor',
	'DS/StuGeometricPrimitives/StuCapsuleActor',
	'DS/StuGeometricPrimitives/StuCylinderActor',
	'DS/StuGeometricPrimitives/StuTorusActor',
	'DS/StuGeometricPrimitives/StuSphereActor',
	'DS/StuGeometricPrimitives/StuConeActor',
	'DS/StuRenderEngine/StuActor3D',
	'DS/StuModel/StuBehavior',
	'DS/StuPhysic/StuPhysicManagerNa'],
	function (STU, DSMath, StuCDSDynFactory, CubeActor, PlaneActor, CapsuleActor, CylinderActor, TorusActor, SphereActor, ConeActor, Actor3D) {
		'use strict';
		...
		RigidBody.prototype.buildCDSDynRigidBody = function () {
			...
			if (MyActor instanceof CubeActor) {
			...
			} else if (MyActor instanceof PlaneActor) {
			...
			} else if (MyActor instanceof CapsuleActor) {
			...
			} else if (MyActor instanceof CylinderActor) {
			...
			} else if (MyActor instanceof TorusActor) {
			...
			} else if (MyActor instanceof SphereActor) {
			...
			} else if (MyActor instanceof ConeActor) {

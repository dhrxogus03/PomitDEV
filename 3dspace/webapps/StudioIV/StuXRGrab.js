define('DS/StudioIV/StuXRGrab',
	['DS/StuCore/StuContext', 'DS/StuModel/StuBehavior', 'DS/EPTaskPlayer/EPTask', 'DS/EP/EP', 'DS/EPEventServices/EPEvent', 'DS/MathematicsES/MathsDef', 'DS/StudioIV/StuXRManager'],
	function (STU, Behavior, Task, EP, EventServices, DSMath, XRManager) {
		'use strict';

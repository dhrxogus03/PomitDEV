...
define("DS/EPSSchematicsCSI/EPSSchematicsCSITools", ["require", "exports", "DS/EPSSchematicsModelWeb/EPSSchematicsBlockLibrary", "DS/EPSSchematicsModelWeb/EPSSchematicsTypeLibrary", "DS/EPSSchematicsModelWeb/EPSSchematicsModelEnums", "DS/EPSSchematicsCSI/typings/CSICommandBinder/EPSSCSICommandBinder", "DS/EPSSchematicsCSI/EPSSchematicsCSIIntrospection"], function (require, exports, BlockLibrary, TypeLibrary, Enums, CSICommandBinder, CSIIntrospection) {
    "use strict";
    var CSITools;
    (function (CSITools) {
        ...
        /**
         * Checks whether the CSI graph block is registered.
         * @public
         * @returns {boolean} Whether the CSI graph is registered.
         */
        function isCSIGraphBlockRegistered() {
            return BlockLibrary.hasBlock(CSITools.CSIGraphBlockUid);
        }
        CSITools.isCSIGraphBlockRegistered = isCSIGraphBlockRegistered;
        /* eslint-disable dot-notation */
         ...
         * @public
         * @param {ICSIPropertyDefinition[]} iCSIPropertyDefinitions - The list of CSI property definitions.
         * @param {string} iParentTypeName - The name of the parent type.
         * @param {ICSIObjectType[]} iObjectTypes - The object types.
         * @param {ICSIEnumType[]} [iEnumTypes] - The enumeration types.
         * @param {ICSIInvalidDefaultValue[]} [iInvalidDefaultValues] - The invalid default values.
         * @returns {ICSITypeDescriptor} The CSI type descriptor.
         */
         ...
         * @returns {TCSIJSONFunction} The CSI signature.
         */

	...
	function (STU, Actor, Event, Dimension, Attachment, EP, DSMath) {
		...
		*/
		var UIActor = function () {
			...
			/**
			 * Mode used to manage the Offset either in Pixels or in Percents.
			 *
			 * @member
			 * @instance
			 * @name offsetMode
			 ...
			 */
			if (STU.isEKIntegrationActive()) {
				this.__offsetMode = false;
			}
			Object.defineProperty(this, "offsetMode", {
				enumerable: true,
				configurable: true,
				get: function () {
					if (!STU.isEKIntegrationActive()) {
						if (this.CATICXPUIActor !== null && this.CATICXPUIActor !== undefined) {
							return this.CATICXPUIActor.getOffsetMode();
						} else { return false; }
					}
					else {
						return this.__offsetMode;
					}
				},
				set: function (iOffsetMode) {
					if (iOffsetMode !== true && iOffsetMode !== false) {
						throw new TypeError('iOffsetMode argument is not a boolean');
					}

					if (this.CATICXPUIActor !== null && this.CATICXPUIActor !== undefined) { this.CATICXPUIActor.setOffsetMode(iOffsetMode); }

					if (STU.isEKIntegrationActive()) {
						this.__offsetMode = iOffsetMode;
					}
				}
			});
			...
			Object.defineProperty(this, "minimumDimension", {
				...
				set: function (iMinimumDimension) {
					if (iMinimumDimension !== null && iMinimumDimension !== undefined && !(iMinimumDimension instanceof Dimension)) {
			...
			Object.defineProperty(this, "attachment", {
				...
				set: function (iAttachment) {
					if (iAttachment !== null && iAttachment !== undefined && !(iAttachment instanceof Attachment)) {

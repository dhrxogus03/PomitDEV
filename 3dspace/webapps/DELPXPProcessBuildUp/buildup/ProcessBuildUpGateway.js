define(["require", "exports", "DS/DELPXPSessionManager/DELPXPContextType", "./DELPXPBuildUpEnums"], function (require, exports, DELPXPContextType_1, DELPXPBuildUpEnums) {
    "use strict";
    ...
    function isTypeBuildUpResult(content) {
        if (content !== null)
            return (content.hasOwnProperty("DELPXPBuildUpComponentResult~1"));
        return false;
    }
    /**
     * function testing the type of the result received
    ...
    function isTypeBuildUpVersion(content) {
        if (content !== null)
            return (content.hasOwnProperty("version"));
        return false;
    }
    /**
    ...
    class ProcessBuildUpGateway {
        ...
        selectionParamJsonCreation(iBUParam) {
            const selectionParams = {
                ...
                selectionGate: iBUParam.getSelectionGate() === DELPXPBuildUpEnums.SelectionMode.SelectionMode_Start ? "Start" : "End"
            };

...
<%
    ...
    tenant = (tenant == null || tenant.isEmpty()) ? "OnPremise" : tenant;
...
<%						
			...
			var ganttUrl = "../webapps/ENOProjectMgmtList/gantt-widget.html?viewId=<%=ProgramCentralConstants.VIEW_STATUS_REPORT%>&initGantt=true&objectId=<%=sOID%>&tenant=<%=tenant%>";
			...
			%>
				...
				chartGantt.innerHTML 	= '<iframe class="taskViewer" width="100%" height="100%" frameBorder="0" type="text/html" src="../webapps/ENOProjectMgmtList/gantt-widget.html?viewId=<%=ProgramCentralConstants.VIEW_STATUS_REPORT%>&initGantt=true&objectId=<%=sOID%>&tenant=<%=tenant%>"></iframe>';
			...
			var linkClick = function(method, header) {
				...
				var ganttUrl = "../webapps/ENOProjectMgmtList/gantt-widget.html?viewId=<%=ProgramCentralConstants.VIEW_STATUS_REPORT%>&projectId=<%=sOID%>&tenant=<%=tenant%>";

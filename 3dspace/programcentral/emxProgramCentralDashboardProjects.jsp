...
<% 	// System.out.println("emxProgramCentralDashboardProjects.jsp :  ---------- START ----------");
	...
	String sLabelRedUp 		= i18nNow.getI18nString("emxFramework.Range.Assessment_Status.RedUp"	, "emxFrameworkStringResource" 	, sLanguage);
	String sLabelGreenUp 	= i18nNow.getI18nString("emxFramework.Range.Assessment_Status.GreenUp"	, "emxFrameworkStringResource" 	, sLanguage);
	String sLabelYellowUp	= i18nNow.getI18nString("emxFramework.Range.Assessment_Status.YellowUp"	, "emxFrameworkStringResource" 	, sLanguage);
	String sLabelRedDown	= i18nNow.getI18nString("emxFramework.Range.Assessment_Status.RedDown"	, "emxFrameworkStringResource" 	, sLanguage);
	String sLabelGreenDown	= i18nNow.getI18nString("emxFramework.Range.Assessment_Status.GreenDown", "emxFrameworkStringResource" 	, sLanguage);
	String sLabelYellowDown	= i18nNow.getI18nString("emxFramework.Range.Assessment_Status.YellowDown", "emxFrameworkStringResource" 	, sLanguage);
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				...
				chartAssessments = new Highcharts.Chart({
					...
					series: [
						{ name	: "<%=sLabelRed%>"		, color	: colorRed		 ,	data	: [<%=aData[42]%>], marker: {symbol: 'url(../common/images/iconStatusRed.png)'} },
						{ name	: "<%=sLabelYellow%>"	, color	: colorYellow	 ,	data	: [<%=aData[43]%>], marker: {symbol: 'url(../common/images/iconStatusYellow.png)'} },
						{ name	: "<%=sLabelGreen%>"	, color	: colorGreen	 ,	data	: [<%=aData[44]%>], marker: {symbol: 'url(../common/images/iconStatusGreen.png)'} },
						{ name	: "<%=sLabelRedUp%>"	, color	: colorRed		 ,	data	: [<%=aData[48]%>], marker: {symbol: 'url(../common/images/iconStatusRed.png)'} },
						{ name	: "<%=sLabelYellowUp%>"	, color	: colorYellow	 ,	data	: [<%=aData[49]%>], marker: {symbol: 'url(../common/images/iconStatusYellow.png)'} },
						{ name	: "<%=sLabelGreenUp%>"	, color	: colorGreen	 ,	data	: [<%=aData[50]%>], marker: {symbol: 'url(../common/images/iconStatusGreen.png)'} },
						{ name	: "<%=sLabelRedDown%>"	, color	: colorRed		 ,	data	: [<%=aData[51]%>], marker: {symbol: 'url(../common/images/iconStatusRed.png)'} },
						{ name	: "<%=sLabelYellowDown%>", color: colorYellow	 ,	data	: [<%=aData[52]%>], marker: {symbol: 'url(../common/images/iconStatusYellow.png)'} },
						{ name	: "<%=sLabelGreenDown%>", color	: colorGreen	 ,	data	: [<%=aData[53]%>], marker: {symbol: 'url(../common/images/iconStatusGreen.png)'} },

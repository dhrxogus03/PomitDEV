...
String strDelimiter = PersonUtil.getFieldSeparator(context);

if(strDelimiter ==null || strDelimiter.length() == 0 || strDelimiter.equalsIgnoreCase("Comma")){
    strDelimiter = ",";
}else if ( strDelimiter.equalsIgnoreCase("Pipe") ){
    strDelimiter = "|";
}else if ( strDelimiter.equalsIgnoreCase("Tab") ){
    strDelimiter = "\t";
}else if ( strDelimiter.equalsIgnoreCase("Semicolon") ){
    strDelimiter = ";";
}
...
if(!toExcel)
{
  ...
  if(toExcel)
  {
	...
	String fileNameStr = "";
	if("Text".equalsIgnoreCase(exportFormat)){
		fileNameStr = "ResourceLoadingSummary" + (new Date()).getTime() + ".txt";
	}else{
		fileNameStr = "ResourceLoadingSummary" + (new Date()).getTime() + ".csv";
	}

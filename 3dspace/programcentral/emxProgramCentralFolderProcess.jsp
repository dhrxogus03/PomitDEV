   ...
   //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    if ("delete".equals(action))
    {
	 ...
	 String isRequirementGroup = (String) folderMap.get(ProgramCentralConstants.SELECT_IS_REQUIREMENT_GROUP);
          ...
          if(slControlledFolderTypeHierarchy.contains((String)folderMap.get(workspaceVault.SELECT_TYPE)) && !(ProgramCentralConstants.STATE_CONTROLLED_FOLDER_CREATE.equals((String) folderMap.get(workspaceVault.SELECT_CURRENT)) || ProgramCentralConstants.STATE_CONTROLLED_FOLDER_ACTIVE.equals((String) folderMap.get(workspaceVault.SELECT_CURRENT))))
          {
              isFolderFrozen = true;
          ...
          //End:25-Nov-10:vf2:R211:IR-080889
          {
			...
			BusinessObject prevRevision = domainObject.getPreviousRevision(context);
			String prevRevType = prevRevision.getTypeName();
			 ...
			 if(ProgramCentralUtil.isNotNullString(prevRevType)){
		            revisionExists = true;
		     }
          }
        }//For
...
//PRG:RG6:R212:30-7-2011:IR-122871V6R2012x:Folder Structure Navigator Delete
        ...
        <script type="text/javascript" language="JavaScript">
				 ...
				 <% if(revisionExists){ %>
		        	contentFrame.refreshDetailsTree();
		        <% } %>
        </script>
        <%
      //PRG:RG6:R212:30-7-2011:IR-122871V6R2012x:Folder Structure Navigator Delete

        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                chartAssessment = new Highcharts.Chart({
                    ...
                    series: [
                        { name  : '<%=report.ASSESSMENT_LABEL_RED%>'    , data : [<%=aAssessmentsData[1]%>], marker: {symbol: 'url(../common/images/iconStatusRed.png)'} },
                        { name  : '<%=report.ASSESSMENT_LABEL_YELLOW%>' , data : [<%=aAssessmentsData[2]%>], marker: {symbol: 'url(../common/images/iconStatusYellow.png)'} },
                        { name  : '<%=report.ASSESSMENT_LABEL_GREEN%>'  , data : [<%=aAssessmentsData[3]%>], marker: {symbol: 'url(../common/images/iconStatusGreen.png)'} },

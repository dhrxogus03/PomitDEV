         ...
         if (selectedids != null && selectedids.length != 0) {
                if (selectedids.length == 1) {
                     ...
                     if (isOfRiskType) {
                      ...
                      errorMessage = ProgramCentralUtil.getPMCI18nString(context,"emxProgramCentral.Common.NotOpportunityType",sLanguage);
                   %>
                     <script language="javascript" type="text/javaScript">
                         alert("<emxUtil:i18nScript localize="i18nId">emxProgramCentral.Common.NotOpportunityType</emxUtil:i18nScript>");
                     </script>
                   <%
                  return;
                     }
...
<%}
           ...
           String strURL = "../common/emxIndentedTable.jsp?table=PMCOpportunitySummary&selection=multiple&Export=true&sortColumnName=Title&sortDirection=ascending&toolbar=PMCOpportunitySummaryToolBar&header=emxProgramCentral.ProgramTop.OpportunityProject&HelpMarker=emxhelpopportunitysummary&freezePane=Name&postProcessJPO=emxTask:postProcessRefresh&hideLaunchButton=true&expandProgramMenu=PMCOpportunityListMenu&showPageURLIcon=false";
           String objectId = emxGetParameter(request, "objectId");

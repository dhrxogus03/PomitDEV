...
public class emxPersonBase_mxJPO extends emxDomainObject_mxJPO
{
	...
	public String getProperty(Context context, String[] args) throws Exception {
		String strNameFormat = EnoviaResourceBundle.getProperty(context, args[0]);// "emxFramework.FullName.Format"
		return strNameFormat;
	}

	public String getSchemaProperty(Context context, String[] args) throws Exception {
		String strSchemaProp = PropertyUtil.getSchemaProperty(context, args[0]);
		return strSchemaProp;
	}

...
import com.matrixone.apps.common.DocumentFlexiRevision;
...
public class IEFCDMUtil_mxJPO
{
    ...
    public String createRevision(Context context, String[] args) throws Exception
    {
     ...
     //   CommonDocument revisedObject =null;
        String revisedObjectId = null;      //TSK8989655 support flexi revision
        String lang = args[0];
        try
        {
        	...
        	revisedObjectId = iefRevise(context, domainObject, copyFiles);
            ...
            if(revisecommentvalue!=null && docName!= null &&  !docName.isEmpty())
            {
	            ...
	            argsToMQL[0] = revisedObjectId; //revisedObject.getObjectId();
    ...
    //TSK8989655 : changed return type as new API returning object ID to support flexi revision
    private String iefRevise(Context context, DomainObject domainObject, boolean copyFiles) throws Exception
    {
    	//CommonDocument revisedObject = ((CommonDocument)domainObject).revise(context, copyFiles);
    	
    	DocumentFlexiRevision docFlexirev = new DocumentFlexiRevision();
    	String sPhysicalId =  domainObject.getInfo(context, "physicalid"); 
    	
    	String objectPhId = docFlexirev.reviseDocument(context, sPhysicalId, copyFiles);
    	
    	
    	DomainObject dObject = DomainObject.newInstance(context, objectPhId);
    	String actaulObjID = dObject.getInfo(context, "id");

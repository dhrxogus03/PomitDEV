    ...
    */
    public int DesignResponsibilityDisconnectCheck(matrix.db.Context context,String[] args) throws Exception
    {
      try
      {
          ...
          SelectList multiValueSelects = new SelectList(1);
          multiValueSelects.addElement(memberName);
          ...
          Map memberMap = organization.getInfo(context,resultSelects,multiValueSelects);

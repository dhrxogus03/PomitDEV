...
//		      System.out.println("Inside ReserveTree: programMap = \n  " + programMap);
	...
	public Map createParameter(Context context, String[] args) throws Exception
	{
		Map programMap = (HashMap) JPO.unpackArgs(args);
		
		String id = (String)programMap.get("objectId");
		
		programMap.put("parentOID", id);
		
		String[] updatedArgs = JPO.packArgs(programMap);
		
		return (Map)JPO.invoke(context, "emxParameterModel", null, "createComposedParameter", updatedArgs, Map.class);
	}

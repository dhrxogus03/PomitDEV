...
public final class ObjectTypeRepReferenceExport_mxJPO extends CompletionJPOEvaluator {
	...
	public final void evaluate(matrix.db.Context iContext, com.dassault_systemes.EKLEngine.common.lib.PLMIDSet iPLMIDSet, com.dassault_systemes.EKLEngine.common.lib.PLMIDSet oPLMIDSet)	
		...
		com.dassault_systemes.EKLEngine.common.lib.PLMIDSet PLMIDMat = new com.dassault_systemes.EKLEngine.common.lib.PLMIDSet();
		...
		PLMIDMat.setValue( com.dassault_systemes.EKLEngine.common.lib.PLMIDSet.Restrict( iContext , PLMIDRefSet, _STRING_8__CATMaterialRef_div_CA ) );
		PSRefRouteSet.setValue( com.dassault_systemes.EKLEngine.completion.lib.Completion.ExecutePLMFunction( iContext , _STRING_9__PRODUCTCFG_, _STRING_10__ProductCfg_AddChildr, new com.dassault_systemes.EKLEngine.common.lib.implementation.ObjectType[] { PSRootSet } ) );
		PSRefSet.setValue( com.dassault_systemes.EKLEngine.common.lib.PLMRouteSet.Ids( PSRefRouteSet, _STRING_2__all_ ) );
		PSRefSet2.setValue( com.dassault_systemes.EKLEngine.common.lib.PLMIDSet.plus( com.dassault_systemes.EKLEngine.common.lib.PLMIDSet.Restrict( iContext , PSRefSet, _STRING_7__PRODUCTCFG_div_VPMRef ), com.dassault_systemes.EKLEngine.common.lib.PLMIDSet.Restrict( iContext , PSRefSet, _STRING_11__PRODUCTCFG_div_VPMRe ) ) );
		PSRepSet.setValue( com.dassault_systemes.EKLEngine.completion.lib.Completion.ExecutePLMProcedure( iContext , _STRING_12__VPMEditor_GetAllRepr, new com.dassault_systemes.EKLEngine.common.lib.implementation.ObjectType[] { PSRefSet2 } ) );
		oPLMIDSet.setValue( com.dassault_systemes.EKLEngine.common.lib.PLMIDSet.plus( com.dassault_systemes.EKLEngine.common.lib.PLMIDSet.plus( com.dassault_systemes.EKLEngine.common.lib.PLMIDSet.plus( com.dassault_systemes.EKLEngine.common.lib.PLMIDSet.plus( com.dassault_systemes.EKLEngine.common.lib.PLMIDSet.plus( iPLMIDSet, PLMIDRepRefSet ), PLMTemplateStructureSet ), PSRefSet ), PSRepSet ), PLMIDMat ) );
	}
}

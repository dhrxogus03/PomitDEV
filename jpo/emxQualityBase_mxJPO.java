         ...
         throws Exception
     {
               ...
               throws Exception
      {
          ...
          try
          {
              ...
              StringList multiValueSelects = new StringList(2);
              multiValueSelects.add(quality.SELECT_QUALITY_METRIC_TITLE);
              multiValueSelects.add(quality.SELECT_QUALITY_METRIC_SIGMA);

              MapList actionList = DomainObject.getInfo(context,
                     objIdArr,busSelects, multiValueSelects);
              Iterator actionsListIterator = actionList.iterator();

...
import com.matrixone.apps.domain.util.XSSUtilStandAlone;
/**
...
public class emxUtilBase_mxJPO
{
   ...
   */
   ...
   public void checkXssInputFilter(Context context, String[] args)throws Exception {
	   XSSUtilStandAlone.checkXssInputPattern(context);

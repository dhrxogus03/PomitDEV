...
/**
    ...
    */
    ...
    /**
     *  Added for the Fix 672436
     * Returns a StringList of the object ids from parent OID which are connected using EBOM Relationship
     * for a given context.
     * @param context the eMatrix <code>Context</code> object.
     * @param args contains a packed HashMap containing objectId of object
     * @return StringList.
    ...
    */
    @com.matrixone.apps.framework.ui.ExcludeOIDProgramCallable
    public StringList excludeOIDAddNext(Context context, String args[])    throws Exception
    {
        HashMap programMap = (HashMap) JPO.unpackArgs(args);
        String  selPartParentObjectId = (String) programMap.get("selPartParentOId");
        StringList result = new StringList();

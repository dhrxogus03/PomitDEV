            ...
            public boolean showCommand(Context context , String[] args)throws Exception {
            	try
            	{
            		...
            		if(programMap.containsKey("objectId") && UIUtil.isNotNullAndNotEmpty((String) programMap.get("objectId"))) {
            			...
            			String loggedInRole = PersonUtil.getActiveSecurityContext(context);
        				boolean isAdminUser= PersonUtil.isVPLMAdmin(context, loggedInRole);
            	 ...
            	 if(args!=null && args.length>0){
            		 ...
            		 if(STATE_ARCHIVE.equals(currentState)) {
            			 ...
            			 try {
            				 ...
            				 templateInfo.put(RouteTemplateNotification.ROUTE_TEMPLATE_ID, sTemplatePhysicalId);
            				 templateInfo.put(RouteTemplateNotification.ROUTE_TEMPLATE_TITLE, sTemplateTitle);
            				 templateInfo.put(RouteTemplateNotification.ROUTE_TEMPLATE_OWNER, sTemplateOwner);
            	 ...
            	 if(args!=null && args.length>0){
            		 ...
            		 if("Active".equals(currentState)) {            			 
            			 try {
            				 ...
            				 String  sTemplateTitle =(String)template.get(DomainObject.SELECT_ATTRIBUTE_TITLE);
            				 String sTemplateOwner =(String)template.get(DomainObject.SELECT_OWNER);
            				 String sTemplatePhysicalId =(String)template.get(DomainObject.SELECT_PHYSICAL_ID);
            				 Map<String, String> templateInfo = new HashMap<>();
            				 templateInfo.put(RouteTemplateNotification.ROUTE_TEMPLATE_ID, sTemplatePhysicalId);
            				 templateInfo.put(RouteTemplateNotification.ROUTE_TEMPLATE_TITLE, sTemplateTitle);
            				 templateInfo.put(RouteTemplateNotification.ROUTE_TEMPLATE_OWNER, sTemplateOwner);
